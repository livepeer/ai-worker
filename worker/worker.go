...
// func (w *Worker) SegmentAnything2Video(ctx context.Context, req BodySegmentAnything2VideoSegmentAnything2VideoPost) (*VideoSegmentResponse, error) {
...
// 	resp, err := c.Client.SegmentAnything2VideoSegmentAnything2VideoPostWithBodyWithResponse(ctx, mw.FormDataContentType(), &buf)
// 	if err != nil {
// 		return nil, err
// 	}
