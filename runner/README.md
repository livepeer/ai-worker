...
docker run -d --add-host=host.docker.internal:host-gateway --gpus all --name realtime -v ~/ai-worker/runner/app:/app -v /tmp/video:/tmp/video livepeer/ai-runner:apps
